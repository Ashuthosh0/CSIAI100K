...
export function NavbarHome() {
  ...
  return (
    <header
      className={cn(
        "fixed top-0 left-0 right-0 z-50 bg-white/90 backdrop-blur-xl border-b border-border transition-transform duration-300 ease-in-out",
        isVisible ? "translate-y-0" : "-translate-y-full"
      )}
    >
      <nav className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-2 lg:h-25">
          {/* CSI Logo - Left side */}
          ...
          <div className="hidden lg:flex items-center gap-6">
            ...
            <Link href="/" className="flex items-center">
              <div className="relative w-16 h-16 lg:w-45 lg:h-45 rounded-xl overflow-hidden">
                <Image
                  src="/csi100klogo.png"
                  alt="CSI100K Logo"
                  width={128}
